...
def rate_mechanic():
    ...
    if form.validate_on_submit():
        ...
        review = Reviews(mechanic=form.mechanic.data, comments=form.comments.data, rating=average)
...
def rate_mechanic():
    ...
    return render_template('DisplayRatings.html', title='Mechanic Dashboard', all_reviews=all_reviews)
